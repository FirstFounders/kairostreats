    ...
    return (
      <header className='showcase-bg'>
        <div className='bg-icon'>
          <img
            className='line-1'
            src='https://i.ibb.co/b2zVrvK/Group-83line6.png'
            alt='Group-83line6'
          />
          <img
            className='line-2'
            src='https://i.ibb.co/c2RGDh1/Group-82line3.png'
            alt='Group-82line3'
          />
          <img
            className='line-3'
            src='https://i.ibb.co/wwnnY6j/Group-80line5.png'
            alt='Group-80line5'
          />
          <img
            className='line-4'
            src='https://i.ibb.co/G2yk1LT/Group-81line4.png'
            alt='Group-81line4'
          />
        </div>
        ...
        <div className='svg-area'>
          ...
          <div className='dot' onClick={() => this.handleDot(1)}>
            {" "}
          </div>
          <div className='dot' onClick={() => this.handleDot(2)}>
            {" "}
          </div>
          <div className='dot' onClick={() => this.handleDot(3)}>
            {" "}
          </div>
          <div className='dot' onClick={() => this.handleDot(4)}>
            {" "}
          </div>
